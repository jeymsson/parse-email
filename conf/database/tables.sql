...
DROP TABLE IF EXISTS `successful_emails`;
...
INSERT INTO mydatabase.successful_emails (affiliate_id,envelope,`from`,subject,dkim,SPF,spam_score,email,raw_text,sender_ip,`to`,`timestamp`) VALUES
	 (123,'{"to":["recipient1@example.com"]}','sender1@example.com','Subject 1','pass','pass',0.1,'From: sender1@example.com
To: recipient1@example.com
Subject: Subject 1
Date: Mon, 1 Jan 2023 12:00:00 +0000
Message-ID: <message1@example.com>

This is the body of the email 1.','','192.168.1.1','recipient1@example.com',1672531199),
	 (124,'{"to":["recipient2@example.com"]}','sender2@example.com','Subject 2','pass','pass',0.2,'From: sender2@example.com
To: recipient2@example.com
Subject: Subject 2
Date: Mon, 1 Jan 2023 12:01:00 +0000
Message-ID: <message2@example.com>

This is the body of the email 2.','','192.168.1.2','recipient2@example.com',1672531200),
	 (125,'{"to":["recipient3@example.com"]}','sender3@example.com','Subject 3','fail','pass',0.3,'From: sender3@example.com
To: recipient3@example.com
Subject: Subject 3
Date: Mon, 1 Jan 2023 12:02:00 +0000
Message-ID: <message3@example.com>

This is the body of the email 3.','','192.168.1.3','recipient3@example.com',1672531201),
	 (126,'{"to":["recipient4@example.com"]}','sender4@example.com','Subject 4','pass','fail',0.4,'From: sender4@example.com
To: recipient4@example.com
Subject: Subject 4
Date: Mon, 1 Jan 2023 12:03:00 +0000
Message-ID: <message4@example.com>

This is the body of the email 4.','','192.168.1.4','recipient4@example.com',1672531202),
	 (127,'{"to":["recipient5@example.com"]}','sender5@example.com','Subject 5','fail','fail',0.5,'From: sender5@example.com
To: recipient5@example.com
Subject: Subject 5
Date: Mon, 1 Jan 2023 12:04:00 +0000
Message-ID: <message5@example.com>

This is the body of the email 5.','','192.168.1.5','recipient5@example.com',1672531203);
